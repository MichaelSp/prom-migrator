...
func newShardsSet(writerCtx context.Context, clientConfig remote.ClientConfig, numShards int) (*shardsSet, error) {
	var (
	...
	for i := 0; i < numShards; i++ {
		client, err := remote.NewWriteClient(fmt.Sprintf("writer-shard-%d", i), &clientConfig)
		if err != nil {
...
func sendSamplesWithBackoff(ctx context.Context, client remote.WriteClient, samples *[]prompb.TimeSeries) error {
